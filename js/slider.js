class Slider {
    ...
    leftRight() {
        ...
        this.box.querySelector(".right-box").addEventListener("click", () => {
            console.log("right")
            if(this.animated) return;
              console.log("right==="+this.index+"=="+this.sliders)  

               console.log(".........."+(parseInt(this.index + 1) > parseInt(this.sliders)))
            if( parseInt(this.index) + 1 > parseInt(this.sliders)){
                this.index = 1;
            }else{
                console.log("right==<5="+this.index)  
                this.index++
            }
